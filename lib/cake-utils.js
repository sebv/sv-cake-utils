...
(function() {
  var exec, execFile, spawn, _ref;

  _ref = require('child_process'), execFile = _ref.execFile, spawn = _ref.spawn, exec = _ref.exec;
  ...
  exports.mocha = {
    test: function(dir) {
      return execFile('find', [dir], function(err, stdout, stderr) {
        var files, params;
  ...
  exports.js = {
    clean: function(dirs, files) {
      return execFile('find', dirs.concat(files), function(err, stdout, stderr) {
        var _files;
        _files = (stdout.split('\n')).filter(function(name) {
  ...
  exports.grepInSource = function(word) {
    return execFile('find', ['.'], function(err, stdout, stderr) {
      var files;
      files = (stdout.split('\n')).filter(function(name) {
  ...
  exports.spawn = function(cmd, params, exitOnError) {
    var proc;
    if (exitOnError == null) {
      exitOnError = true;
    }
